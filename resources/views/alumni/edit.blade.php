        ...
        <div class="card p-6">
            <form method="POST" action="{{ route('alumni.update', $alumni) }}" class="space-y-5">
                ...
                <div class="relative">
                    ...
                    <input type="hidden" name="lat" id="lat" value="{{ old('lat', $alumni->lat) }}">
                    <input type="hidden" name="lng" id="lng" value="{{ old('lng', $alumni->lng) }}">
                    ...
                    <div class="flex items-center justify-between mt-1">
                        ...
                        @if($alumni->lat && $alumni->lng)
                            <span id="coord-status" class="text-xs font-medium text-green-600 dark:text-green-400">📍 Koordinat sudah ada</span>
                        @else
