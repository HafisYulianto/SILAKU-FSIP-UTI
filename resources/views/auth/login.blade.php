<x-layouts.guest :title="'Login'">
    <div class="max-w-5xl w-full mx-auto bg-white rounded-[2rem] overflow-hidden shadow-2xl border border-gray-100 grid md:grid-cols-12 min-h-[600px] transition-all duration-500">
        
        <!-- Left: Form section (Clean white contrast) -->
        <div class="md:col-span-7 p-8 sm:p-12 md:p-16 flex flex-col justify-between bg-white">
            <div>
                <!-- Brand logo & header -->
                <div class="flex items-center gap-3 mb-10">
                    <img src="{{ asset('images/002-UTI.png') }}" alt="Logo UTI" class="h-10 w-auto object-contain">
                    <div>
                        <h2 class="text-xl font-black text-gray-900 tracking-tight leading-none">SILAKU</h2>
                        <p class="text-[10px] text-gray-500 font-medium tracking-wide">FSIP Universitas Teknokrat Indonesia</p>
                    </div>
                </div>

                <div class="mb-8">
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Selamat Datang Kembali</h3>
                    <p class="text-sm text-gray-500">Silakan masuk menggunakan akun administrasi Anda.</p>
                </div>
            ...
            <!-- Left section footer -->
            <div class="pt-10 border-t border-gray-100 mt-8 flex justify-between items-center text-xs text-gray-400">
