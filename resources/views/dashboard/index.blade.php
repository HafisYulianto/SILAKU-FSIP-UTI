<x-layouts.app :title="'Dashboard Akreditasi'">
    <div class="space-y-8 fade-in" x-data="{}" x-init="
        $watch('darkMode', val => {
    ...
    ">
        ...
        <div class="page-header">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('dashboard.print') }}" target="_blank" class="px-3.5 py-2 text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 rounded-xl shadow-xs flex items-center gap-1.5 transition-all duration-200">
